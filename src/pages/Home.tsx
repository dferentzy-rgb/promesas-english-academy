  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-red-600 via-red-700 to-red-800 text-white py-24">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/children"
              className="inline-flex items-center justify-center bg-white text-red-700 px-8 py-4 rounded-lg hover:bg-red-50 transition font-semibold text-lg shadow-lg"
            >
              {t.home.viewChildren}
            ...
            <Link
              to="/signup"
              className="inline-flex items-center justify-center bg-red-800 text-white px-8 py-4 rounded-lg hover:bg-red-900 transition font-semibold text-lg border-2 border-white"
            >
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">{t.home.howItWorksTitle}</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-red-600 to-red-700 rounded-3xl p-12 md:p-16 text-white text-center shadow-2xl">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">{t.home.aboutTitle}</h2>
